...
public class SpecialEventTest {
    ...
    public void testGetText() {
        specialEvent = new SpecialEvent("test", 0, 0, "Option A", "Option B", "Test Message");
        String result = specialEvent.getText();
        assertEquals("Test Message", result);
    }

    @Test
    public void testGetLp() {
        specialEvent = new SpecialEvent("test", 10, 0, "Option A", "Option B", "Test Message");
        int result = specialEvent.getLp();
        assertEquals(10, result);
    }

    @Test
    public void testGetCash() {
        specialEvent = new SpecialEvent("test", 0, 50, "Option A", "Option B", "Test Message");
        int result = specialEvent.getCash();
    ...
    public void testGetMessage() {
        specialEvent = new SpecialEvent("test", 0, 0, "Option A", "Option B", "Test Message");
        String result = specialEvent.getMessage();
        assertEquals("Test Message", result);
    }
    ...
    public void testGetOptionA() {
        specialEvent = new SpecialEvent("test", 0, 0, "Option A", "Option B", "Test Message");
        String result = specialEvent.getOptionA();
    ...
    public void testGetOptionB() {
        specialEvent = new SpecialEvent("test", 0, 0, "Option A", "Option B", "Test Message");
        String result = specialEvent.getOptionB();
    ...
    public void testGetType() {
        specialEvent = new SpecialEvent("test", 0, 0, "Option A", "Option B", "Test Message");
        String result = specialEvent.getType();
    ...
    public void testToString() {
        specialEvent = new SpecialEvent("test", 0, 0, "Option A", "Option B", "Test Message");
        String result = specialEvent.toString();
